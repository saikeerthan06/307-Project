...
#     """
#     Ensures we use the same feature ordering as preprocessing.
#     If meta is missing, we fallback to 'all columns except target'.
#     """
...
#         final_cols = meta["final_columns"]
#         # Some preprocess_meta include target at the end; ensure it exists in df
...
#     early_stopping_rounds: Optional[int],  # <- kept for API compatibility, but IGNORED
#     model_dir: str,
#     artifacts_dir: str,
...
#     # Train/val/test split (stratify if desired & possible)
...
#     if "num_class" not in params and (params.get("objective", "").startswith("multi")):
#         params["num_class"] = num_classes

#     model = XGBClassifier(**params)

#     # NOTE: We IGNORE early_stopping_rounds for maximum version compatibility.
#     # Some XGBoost builds remove this kwarg from the sklearn API .fit().
#     # You still get eval metrics below.
#     eval_set = [(X_train, y_train), (X_val, y_val)]
#     model.fit(X_train, y_train, eval_set=eval_set, verbose=False)

#     # Metrics (quick & simple)
#     # Metrics (quick & simple)
